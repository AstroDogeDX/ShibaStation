...
petting-success-kerfer-cyborg = You pet {THE($target)} on {POSS-ADJ($target)} cute cat-shaped head. Meow!
...
petting-failure-kerfer-cyborg = You reach out to pet {THE($target)}, but {SUBJECT($target)} {CONJUGATE-BE($target)} busy looking aloof!
